...
async function fetchZonesForCampaign(
  ...
  try {
    ...
    // Filter by campaign (matches your URL: filter1=campaign&filter1Value=...)
 ...
 * If your creative report uses slightly different columns, this will still
 * work for core metrics (visits/conversions/revenue/cost/roi).
 */
...
export async function GET(request: Request) {
  ...
  try {
    ...
    const maxDetailCampaigns = 10; // only fetch zones/creatives for first N campaigns to keep it fast

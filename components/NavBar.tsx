          ...
          {pathname === "/" ? (
            <>
              ...
              {(me?.role === "admin" || me?.perms?.creatives || !me) && (
                <button onClick={() => router.push("/creative-request")} className={`px-4 py-1.5 rounded-full hover:bg-slate-800 ${activeTab === "creatives" ? "bg-emerald-500 text-slate-900" : "text-slate-200"}`}>Creatives</button>
              )}
